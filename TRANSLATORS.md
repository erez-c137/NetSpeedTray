...
NetSpeedTray's UI is available in 11 languages - including Hebrew, its first right-to-left locale - thanks to the community contributors below. Each name represents real time and care invested in making the app feel native to its users - thank you.
