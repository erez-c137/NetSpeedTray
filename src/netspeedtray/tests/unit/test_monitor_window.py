...
def test_import_firewall_no_matplotlib_at_module_scope():
    ...
    code = (
        ...
        "import netspeedtray.views.monitor.hardware.tab\n"
        "import netspeedtray.views.monitor.hardware.list\n"
        "import netspeedtray.views.monitor.hardware.feed\n"
        "import netspeedtray.views.monitor.hardware.worker\n"
