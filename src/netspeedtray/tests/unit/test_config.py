...
def test_validate_config_handles_inflated_legacy_threshold(config_manager):
    """Stale v1.2.6 config with an unrealistically large high threshold resets to defaults."""
