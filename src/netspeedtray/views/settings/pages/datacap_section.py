...
English literals pending the single i18n pass.
"""
...
class DataCapSettings(QWidget):
    ...
    def __init__(self, on_change: Callable[[], None]) -> None:
        ...
        self._expander = SettingExpander(
            "Data usage", "Warn me as I approach a monthly limit",
